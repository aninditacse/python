# -*- coding: utf-8 -*-
"""
Created on Sat Mar 13 16:12:21 2021
...
def writefile(img,t1,t2,t3,t4):
    im=open(r'C:\Users\Anindita\Desktop\Python code\original1_bit.pgm',"w")
    im.write("%s"%t1)
    im.write("%s"%t2)
    im.write("%s"%t3)
    im.write("%s"%t4)
...
img,p1,p2,t1,p3=readfile(r'C:\Users\Anindita\Desktop\Python code\original1.pgm')
...
imag1=writefile(b4,p1,p2,t1,p3)
print(img)
print(imag1)
