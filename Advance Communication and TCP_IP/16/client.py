# -*- coding: utf-8 -*-
"""
Created on Wed Jun 23 00:15:48 2021
...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 22 23:19:38 2021
...
#    print ("# [2] Subtract               #")
    ...
    if option == "1":
        try:
            message1 = (input("Enter a string: "))
#            message2 = int(input("Enter number 2: "))
        except KeyboardInterrupt:
            print('\nThe connection was finished successfully...')
            break
        returnedMessage = tryToUseMethodAnyServer('add_num', message1)
        if returnedMessage:
